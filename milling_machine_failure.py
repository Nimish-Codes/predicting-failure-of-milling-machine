...
st.warning('This is a trained model to predict the failure of a *[milling machine](https://www.google.com/search?q=what+is+milling+machine&oq=what+is+milling+machine&gs_lcrp=EgZjaHJvbWUyDggAEEUYFBg5GIcCGIAEMgcIARAAGIAEMgwIAhAAGBQYhwIYgAQyBwgDEAAYgAQyBwgEEAAYgAQyBwgFEAAYgAQyBwgGEAAYgAQyCAgHEAAYFhgeMgoICBAAGA8YFhgeMgoICRAAGA8YFhge0gEINjY1NWowajeoAgCwAgA&sourceid=chrome&ie=UTF-8)* \n\n according to user given conditions at a time')
